...
class InferenceService:
    ...
    def run(self) -> None:
        ...
        **Example Class Usage:**
        ...
        for frame, count in stream.capture_video():
            predictions = self.detector.predict(frame)
            bboxes, class_ids, confidence_scores, class_scores =self.detector.post_process(predictions)
            ...
            self.save_frame(processed_frame,count)
